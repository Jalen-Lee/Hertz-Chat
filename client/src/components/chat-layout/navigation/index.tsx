  ...
  return (
    <nav className="chat-layout-navigation-container">
      ...
      <div className="tabs-list">
        <div className="row-1">
          <NavTabItem
            id={NavTabItemName.CONVERSATIONS_LIST}
            title="会话列表"
            onClick={onNavItemClick}
            isActive={currentTab === NavTabItemName.CONVERSATIONS_LIST}
          >
            <ChatIcon fontSize={'large'} />
          </NavTabItem>
          <NavTabItem
            id={NavTabItemName.CONTACTS_LIST}
            title="好友列表"
            onClick={onNavItemClick}
            isActive={currentTab === NavTabItemName.CONTACTS_LIST}
          >
        ...
        <div className="row-2">
          <NavTabItem
            id={NavTabItemName.CHAT_SETTING}
            title="设置"
            onClick={onNavItemClick}
            isActive={currentTab === NavTabItemName.CHAT_SETTING}
          >
